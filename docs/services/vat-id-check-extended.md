...
| companyStreetFull  | String          | Ja, wenn companyStreet und companyHouseNumber nicht gesetzt sind | Enthält den Straßennamen inkl. Hausnummer der zu prüfenden Firma                                                                                                                                                                                                                                                                                                   |
| companyStreet      | String          | Ja, wenn companyStreetFull nicht gesetzt ist                     | Enthält den Straßennamen der zu prüfenden Firma                                                                                                                                                                                                                                                                                                                    |
| companyHouseNumber | String          | Ja, wenn companyStreetFull nicht gesetzt ist                     | Enthält die Hausnummer der zu prüfenden Firma                                                                                                                                                                                                                                                                                                                      |
...
| allowCache         | Boolean         | Nein                                                             | (Beta) Mit diesem Parameter kann gesteuert werden, ob in der Antwort nur Live-Daten vom Bundeszentralamt für Steuern oder auch Daten aus dem Cache enthalten sein dürfen. Hier wird entweder true oder false erwartet. Wenn dieser Parameter nicht gesetzt ist, wird true verwendet.                                                                               |
